...
public class MetaballsGroup extends GameObject{

	ShaderProgram shader;
	ArrayList<Metaball> blobs;
	...
	public MetaballsGroup(ObjectInfo info) {
		super(info);
		
		ShaderProgram.pedantic = false;
		
		blobs = new ArrayList<Metaball>();
	...
	public void addBlob(Metaball blob) {
