...
public class CameraComponent extends LireComponent{
	...
	public VisTable getUITable(DragAndDrop dragndrop) {
		...
		final VisValidatableTextField widthTxt = new VisValidatableTextField(InputValidatorConstants.floatValidator);
		...
		final VisValidatableTextField heightTxt = new VisValidatableTextField(InputValidatorConstants.floatValidator);
		...
		final VisValidatableTextField zoomTxt = new VisValidatableTextField(InputValidatorConstants.floatValidator);
