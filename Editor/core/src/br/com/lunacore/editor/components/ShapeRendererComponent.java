package br.com.lunacore.editor.components;
...
import br.com.lunacore.editor.LireComponent;
import br.com.lunacore.editor.LireObject;
import br.com.lunacore.editor.utils.InputValidatorConstants;
import br.com.lunacore.editor.utils.UIConstants;
...
public class ShapeRendererComponent extends LireComponent{
	...
	public VisTable getShapeTable(final ShapeDef def) {
		...
		final VisSelectBox<ShapeType> types = new VisSelectBox<ShapeType>();
		...
		final VisTextButton colorbtn = new VisTextButton("Pick color");
		...
		if(def instanceof RectDef) {
			final RectDef cast = (RectDef) def;
			...
			final CircleDef cast = (CircleDef) def;
			...
			int i = 0;
			for(final Vector2 v : cast.points) {
