...
import br.com.lunacore.editor.utils.NinePatchLoader;
...
public class SpriteComponent extends LireComponent{
	...
	public VisTable getUITable(DragAndDrop dragndrop) {
		...
		final VisTextField spriteLoc = new VisTextField(getLocalPath(spriteHandle));
		...
		colorbtn.addListener(new ClickListener() {
			public void clicked(InputEvent event, float x, float y) {
				...
				//Tá meio bugado, ele não abre com a cor default
