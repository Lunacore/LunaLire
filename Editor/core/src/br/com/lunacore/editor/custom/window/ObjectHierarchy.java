...
public class ObjectHierarchy extends LireEditorWindow{
	...
	public void populate() {
		if(Editor.getInstance().getStage() != null) {
			for(EditorLireObject l : Editor.getInstance().getStage().getObjectsInScene()) {
