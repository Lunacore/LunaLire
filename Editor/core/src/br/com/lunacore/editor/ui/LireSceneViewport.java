...
import br.com.lunacore.editor.custom.EditorRuler;
import br.com.lunacore.editor.custom.EditorWindow;
import br.com.lunacore.editor.custom.ObjectPresets;
...
public class LireSceneViewport extends Stage{
	...
	public LireSceneViewport(Viewport UIViewport) {
		...
		tbl.setPosition(0, 0);
		tbl.setSize(Gdx.graphics.getWidth(), Gdx.graphics.getHeight() - Editor.getInstance().getUIState().getTopBar().getTable().getHeight());
