...
import br.com.lunacore.awesome.math.Transform;
...
public class Helper {
	...
	public static void renderRegion(Batch sb, TextureRegion region, Transform transform, boolean flipX, boolean flipY) {
		renderRegion(sb, region, transform.getPosition(), transform.getAngle(), transform.getScale(), flipX, flipY);
	}
		
	public static void renderRegion(Batch sb, TextureRegion region, Vector2 position, float angle, Vector2 size,
	...
	public static void renderRegionNoCenter(Batch sb, TextureRegion region, Vector2 position, float angle, Vector2 size,
			boolean flipX, boolean flipY) {
	...
	public static void renderTex(Batch sb, Texture tex, Transform transform, boolean flipX, boolean flipY) {
		renderTex(sb, tex, transform.getPosition(), transform.getAngle(), transform.getScale(), flipX, flipY);
	}
	
	public static void renderTex(Batch sb, Texture tex, Vector2 position, Vector2 rectSize) {
		sb.draw(tex,
				position.x,
				position.y,
				0,
	...
	public static void renderTexNoCenter(Batch sb, Texture texture, Vector2 position, float angle, Vector2 size,
			boolean flipX, boolean flipY) {
	...
	public static void renderTex(Batch sb, Texture tex, Vector2 position, Vector2 rectSize, float scale) {
		sb.draw(tex,
				position.x,
				position.y,
				0,
	...
	//sem transform
	public static void renderTex(Batch sb, Texture tex, Vector2 position, float angle, Vector2 size, boolean flipX, boolean flipY) {
		sb.draw(
				tex,
	...
	public static Matrix4 getScreenProjection() {
		Matrix4 m =  new Matrix4().setToOrtho(0, Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), 0, 0, 1);
		return m;
	}
	
	public static Vector3 projectIntoScreenPos(Camera camera, Vector3 position) {
		Vector3 out = camera.project(position);
	...
	public static void drawFont(Batch sb, BitmapFont font, OrthographicCamera camera, String text, Vector2 position) {
	...
	public static void drawUIFont(Batch sb, BitmapFont font, OrthographicCamera camera, String text, Vector2 position) {
		Matrix4 lastProj = sb.getProjectionMatrix().cpy();
		sb.setProjectionMatrix(Helper.getDefaultProjection());
